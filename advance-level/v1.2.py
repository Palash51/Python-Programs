################### user will never win after 3 moves  in v.1.2 ######################
...
class MainTictactoe(TictactoeAbstract):
    ...
    def check_wining_places(self):
    	...
    	# available_places = [x for x in self.winning_rows if (set(players_index).issubset(x))][-1][-1]
    	# import pdb
    	# pdb.set_trace()
    ...
    # def check_defending_place(self):
    # 	pass
